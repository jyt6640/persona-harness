export function createPlanOnlyPrompt(): string {
  return [
    ...
    "Windows PowerShell: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content README.md -TotalCount 220\"'`, then `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content README.md | Select-Object -Skip 220 -First 220\"'`.",
    "Windows search: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-ChildItem -Recurse -File | Select-String -Pattern TODO\"'`.",
    "",

...
export function createPlanOnlyPrompt(): string {
  return [
    ...
    "",
    "코드 구조 분석이나 변경 영향 파악은 먼저 PH-owned surfaces(accepted plan, workflow check/closure, ast-grep conventions, relay handoff)를 확인해줘. 외부 codegraph/code-nav 도구는 실제로 설치되어 있을 때만 선택적으로 사용하고 PH-owned 또는 token saving으로 주장하지 마.",
    "",

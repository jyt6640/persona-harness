...
function implementationGateOutput(planPath: string, status: string): string {
  return [
    ...
    "- Before implementation, run `npx ph workflow guard implement`.",
    ...
    "- Before final answer, fill the review report after manual QA, run `npx ph plan --report-filled review`, then run `npx ph workflow guard final`.",
    "",

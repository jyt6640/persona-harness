...
function createPlanDraft(projectDir: string): string {
  ...
  return [
    ...
    "- Windows search는 `npx ph bearshell powershell -NoProfile -Command \"Get-ChildItem -Path README.md,src,.persona -Recurse -File -ErrorAction SilentlyContinue | Select-String -Pattern TODO\"` 형태를 사용한다.",

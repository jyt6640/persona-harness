...
function createPlanDraft(projectDir: string): string {
  ...
  return [
    ...
    "- Windows PowerShell: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content README.md -TotalCount 220\"'`.",
    "- Windows search는 `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-ChildItem -Recurse -File | Select-String -Pattern TODO\"'` 형태를 사용한다.",

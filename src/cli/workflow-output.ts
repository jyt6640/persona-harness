...
export function passedImplementOutput(): CliRunResult {
  return {
    ...
    stdout: [
      ...
      "2. After Java files are generated or changed, run `npx ph bearshell --shell 'find src/main/java src/test/java -name \"*.java\" 2>/dev/null | sort'` so Persona Harness can discover generated Java roles.",
      ...
      "5. Fill `.persona/workflow/implementation-report.md` with README read method, README ranges read, plan read method, plan ranges read, and Java role discovery/read evidence.",
      ...
      "10. Do not give the final answer until `npx ph workflow finish implement` passes.",
      "",
      "Scope:",
      "- AI-facing workflow rail",

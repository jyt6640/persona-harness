...
export function passedImplementOutput(): CliRunResult {
  return {
    ...
    stdout: [
      ...
      "1. `npx ph bearshell --shell 'sed -n \"1,220p\" .persona/project-profile.jsonc'`",
      "2. Record project profile read method and ranges read in `.persona/workflow/implementation-report.md`.",
      "",
      "Project mode:",

...
export function passedImplementOutput(): CliRunResult {
  return {
    ...
    stdout: [
      ...
      "4. Windows PowerShell first chunk: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content README.md -TotalCount 220\"'`",
      "5. Windows PowerShell next chunk: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content README.md | Select-Object -Skip 220 -First 220\"'`.",
      "6. Continue 220-line ranges until README.md and plan are fully covered.",
      "7. Windows search: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-ChildItem -Recurse -File | Select-String -Pattern TODO\"'`.",
      ...
      "2. Windows PowerShell: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-Content .persona/project-profile.jsonc -TotalCount 220\"'`",
      ...
      "   - Windows PowerShell: `npx ph bearshell --shell 'powershell -NoProfile -Command \"Get-ChildItem -Path src/main/java,src/test/java -Recurse -File -Filter *.java -ErrorAction SilentlyContinue | Sort-Object FullName | Select-Object -ExpandProperty FullName\"'`",

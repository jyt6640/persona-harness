...
function passedStartOutput(runnerKind: WorkflowRunnerKind): CliRunResult {
  return {
    ...
    stdout: [
      ...
      "3. Use codegraph MCP before raw file reads for code structure analysis when available.",
      "4. Implement from the accepted plan.",
      "5. Use `npx ph bearshell` for shell verification.",
      "6. Fill `.persona/workflow/implementation-report.md`.",
      "7. Run `npx ph plan --report-filled implementation`.",
      "8. Fill `.persona/workflow/review-report.md` after review/manual QA.",
      "9. Run `npx ph plan --report-filled review`.",
      "10. Run `npx ph workflow finish implement`.",
      "11. Do not give the final answer until `npx ph workflow finish implement` passes.",
      "",
      "Scope:",

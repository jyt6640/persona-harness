...
export function bearshellUsage(invocation = "ph"): string {
  return [
    ...
    '- If `--shell` is required from cmd/Git Bash, use double quotes around the full command and escaped inner quotes: `npx ph bearshell --shell "powershell -NoProfile -Command \\"Get-ChildItem -Recurse -File | Select-String -Pattern TODO\\""`',

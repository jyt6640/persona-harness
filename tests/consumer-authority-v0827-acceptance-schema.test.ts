...
describe("consumer authority 0.8.27 acceptance schema", () => {
  it("binds the current package to source provenance remediation without a static channel snapshot", () => {
    const manifest = readV0827AcceptanceManifest(repositoryRoot)
  ...
  it("routes current external preflights through v0827 and keeps v0826 historical", () => {
    for (const script of [

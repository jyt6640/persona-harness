...
import { readV0814AcceptanceManifest } from "../scripts/consumer-authority-v0814-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0814AcceptanceManifest(repositoryRoot)

...
import { readV0823AcceptanceManifest } from "../scripts/consumer-authority-v0823-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0823AcceptanceManifest(repositoryRoot)

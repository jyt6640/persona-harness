...
import { readV0818AcceptanceManifest } from "../scripts/consumer-authority-v0818-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0818AcceptanceManifest(repositoryRoot)

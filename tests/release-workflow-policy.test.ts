...
import { readV0822AcceptanceManifest } from "../scripts/consumer-authority-v0822-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0822AcceptanceManifest(repositoryRoot)

...
import { readV0820AcceptanceManifest } from "../scripts/consumer-authority-v0820-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0820AcceptanceManifest(repositoryRoot)

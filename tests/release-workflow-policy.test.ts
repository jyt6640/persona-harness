...
import { readV0812AcceptanceManifest } from "../scripts/consumer-authority-v0812-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0812AcceptanceManifest(repositoryRoot)

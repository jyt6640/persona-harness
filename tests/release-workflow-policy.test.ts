...
import { readV088AcceptanceManifest } from "../scripts/consumer-authority-v088-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV088AcceptanceManifest(repositoryRoot)

...
import { readV0813AcceptanceManifest } from "../scripts/consumer-authority-v0813-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0813AcceptanceManifest(repositoryRoot)

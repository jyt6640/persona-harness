...
import { readV0825AcceptanceManifest } from "../scripts/consumer-authority-v0825-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0825AcceptanceManifest(repositoryRoot)

...
import { readV087AcceptanceManifest } from "../scripts/consumer-authority-v087-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV087AcceptanceManifest(repositoryRoot)

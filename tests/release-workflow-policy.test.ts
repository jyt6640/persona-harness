...
import { readV0815AcceptanceManifest } from "../scripts/consumer-authority-v0815-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0815AcceptanceManifest(repositoryRoot)

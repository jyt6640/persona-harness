...
import { readV0824AcceptanceManifest } from "../scripts/consumer-authority-v0824-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0824AcceptanceManifest(repositoryRoot)

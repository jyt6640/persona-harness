...
import { readV0826AcceptanceManifest } from "../scripts/consumer-authority-v0826-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0826AcceptanceManifest(repositoryRoot)

...
import { readV0827AcceptanceManifest } from "../scripts/consumer-authority-v0827-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0827AcceptanceManifest(repositoryRoot)

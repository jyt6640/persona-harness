...
import { readV0821AcceptanceManifest } from "../scripts/consumer-authority-v0821-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0821AcceptanceManifest(repositoryRoot)

...
import { readV0819AcceptanceManifest } from "../scripts/consumer-authority-v0819-acceptance-schema.mjs"
...
describe("release workflow policy", () => {
  ...
  it("keeps the current source candidate unpublishable until a matching approval is recorded", () => {
    ...
    const acceptance = readV0819AcceptanceManifest(repositoryRoot)

...
describe("package files policy", () => {
  ...
  it("keeps all source convention yaml files covered by packaged files", () => {
    ...
    expect(conventionFiles).toHaveLength(13)
  ...
  it("packages the enrolled consumer-authority retrieval path without packaging its synthetic evidence", () => {
    ...
    const packagedScripts = [
      ...
      "scripts/consumer-authority-current-acceptance-schema.d.mts",
      "scripts/consumer-authority-current-acceptance-schema.mjs",
    ...
    const boundaryRecords = [
      ...
      "docs/current/release/consumer-authority-v084-acceptance.json",
      "docs/current/release/consumer-authority-v085-acceptance.json",
      "docs/current/release/consumer-authority-v086-acceptance.json",
      "docs/current/release/consumer-authority-v087-acceptance.json",
      "docs/current/release/consumer-authority-v088-acceptance.json",
      "docs/current/release/consumer-authority-v089-acceptance.json",
      "docs/current/release/consumer-authority-v0810-acceptance.json",
      "docs/current/release/consumer-authority-v0811-acceptance.json",
      ...
      "docs/current/release/consumer-authority-v0816-acceptance.json",
      "docs/current/release/consumer-authority-v0817-acceptance.json",
      "docs/current/release/consumer-authority-v0818-acceptance.json",
      "docs/current/release/consumer-authority-v0819-acceptance.json",
      ...
      "docs/current/release/consumer-authority-v0824-acceptance.json",
      "docs/current/release/consumer-authority-v0825-acceptance.json",
      "docs/current/release/consumer-authority-v0826-acceptance.json",
      "docs/current/release/consumer-authority-v0827-acceptance.json",
      ...
      "docs/current/release/consumer-authority-current-acceptance.json",
    ]

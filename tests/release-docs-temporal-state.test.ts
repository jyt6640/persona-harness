...
describe("release docs temporal-state boundary", () => {
  it("keeps historical final-observer evidence distinct from the beta.26 workflow-selected procedure candidate", () => {
    ...
    expect(text).toContain("consumer-authority-beta26-acceptance.json")

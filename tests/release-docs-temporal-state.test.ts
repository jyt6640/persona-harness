...
describe("release docs temporal-state boundary", () => {
  it("keeps the consumer authority beta.17 source candidate free of beta publication claims", () => {
    ...
    expect(text).toContain("0.8.0-beta.17")
    expect(text).toContain("consumer-authority-beta17-acceptance.json")

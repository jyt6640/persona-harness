...
describe("release docs temporal-state boundary", () => {
  it("keeps the consumer authority beta.16 source candidate free of beta publication claims", () => {
    ...
    expect(text).toContain("0.8.0-beta.16")
    expect(text).toContain("consumer-authority-beta16-acceptance.json")

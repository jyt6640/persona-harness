...
describe("release docs temporal-state boundary", () => {
  it("keeps the consumer authority beta.13 source candidate free of beta publication claims", () => {
    ...
    expect(text).toContain("0.8.0-beta.13")
    expect(text).toContain("consumer-authority-beta13-acceptance.json")

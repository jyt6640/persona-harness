...
> Stable npm channel: `persona-harness@latest=0.5.0`; release prep target is `0.6.0-rc.1` for the prerelease `next` channel. Until QA publish GO plus registry gitHead/shasum verification, registry `next` remains `0.5.0-rc.2`; alpha remains `0.3.9-alpha.8`.

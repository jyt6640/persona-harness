...
try {
  ...
  run(installedBin, ["bootstrap", "backend", "--runtime-injection-preview", "--no-developer-mcp"], { cwd: demoProjectDir })
  ...
  assertIncludes("tool output", toolOutput.output, "File role: controller")

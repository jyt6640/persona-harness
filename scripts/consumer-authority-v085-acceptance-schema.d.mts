...
export class V085AcceptanceManifestError extends Error {
  readonly code: "v085-acceptance-schema"
}

export type V085AcceptanceManifest = Readonly<Record<string, unknown>> & Readonly<{
...
export function canonicalV085AcceptanceManifest(): V085AcceptanceManifest
export function readV085AcceptanceManifest(packageRoot: string): V085AcceptanceManifest
export function parseV085AcceptanceManifest(value: unknown, packageVersion: string): V085AcceptanceManifest

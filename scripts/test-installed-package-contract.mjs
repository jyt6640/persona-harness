...
import { readV0818AcceptanceManifest } from "./consumer-authority-v0818-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0818AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0818AcceptanceManifest(packageRoot)
  } catch {

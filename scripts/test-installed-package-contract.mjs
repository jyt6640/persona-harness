...
import { readV0813AcceptanceManifest } from "./consumer-authority-v0813-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0813AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0813AcceptanceManifest(packageRoot)
  } catch {

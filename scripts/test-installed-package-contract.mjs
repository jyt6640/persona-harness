...
import { readV084AcceptanceManifest } from "./consumer-authority-v084-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV084AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV084AcceptanceManifest(packageRoot)
  } catch {
...
function assertExternalAttestationCommandPlan(packageRoot, cwd, label, observerGh) {
  ...
  for (const script of [
    ...
    "consumer-authority-v084-acceptance-schema.mjs",

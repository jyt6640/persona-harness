...
import { readV0810AcceptanceManifest } from "./consumer-authority-v0810-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0810AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0810AcceptanceManifest(packageRoot)
  } catch {

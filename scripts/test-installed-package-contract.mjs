...
import { readV088AcceptanceManifest } from "./consumer-authority-v088-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV088AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV088AcceptanceManifest(packageRoot)
  } catch {

...
import { readV0820AcceptanceManifest } from "./consumer-authority-v0820-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0820AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0820AcceptanceManifest(packageRoot)
  } catch {

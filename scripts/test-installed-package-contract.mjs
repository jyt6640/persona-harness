...
import { readV0819AcceptanceManifest } from "./consumer-authority-v0819-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0819AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0819AcceptanceManifest(packageRoot)
  } catch {

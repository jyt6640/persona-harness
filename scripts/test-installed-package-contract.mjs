...
import { readV0827AcceptanceManifest } from "./consumer-authority-v0827-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0827AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0827AcceptanceManifest(packageRoot)
  } catch {

...
import { readV089AcceptanceManifest } from "./consumer-authority-v089-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV089AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV089AcceptanceManifest(packageRoot)
  } catch {

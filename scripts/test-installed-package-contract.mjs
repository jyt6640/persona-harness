...
import { readV085AcceptanceManifest } from "./consumer-authority-v085-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV085AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV085AcceptanceManifest(packageRoot)
  } catch {

...
import { readV0825AcceptanceManifest } from "./consumer-authority-v0825-acceptance-schema.mjs"
import {
...
function readGaPreAuthorityReadiness(packageRoot) {
  const manifest = readV0825AcceptanceManifest(packageRoot)
  return {
...
function assertPrearmedObserverHandoff(packageRoot, label) {
  try {
    readV0825AcceptanceManifest(packageRoot)
  } catch {
...
function assertExternalAttestationCommandPlan(packageRoot, cwd, label, observerGh) {
  ...
  for (const script of [
    ...
    "consumer-authority-v0825-acceptance-schema.mjs",

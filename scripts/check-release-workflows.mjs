...
const requirements = [
  ...
  ["project finish attester reusable binding", ".github/workflows/persona-harness-project-finish.yml", (text) => text.includes("repository: jyt6640/persona-harness") && text.includes("ref: ${{ github.workflow_sha }}") && text.includes("GITHUB_WORKFLOW_SHA") && text.includes("build-project-finish-attestation.mjs")],

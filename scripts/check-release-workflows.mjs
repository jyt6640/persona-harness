...
const requirements = [
  ...
  ["project finish context diagnostic hosted selftest", ".github/workflows/project-finish-context-diagnostic-selftest.yml", (text) => text.includes("pull_request:") && text.includes("push:") && text.includes("runs-on: ubuntu-latest") && text.includes("uses: ./.github/actions/project-finish-context-diagnostic-selftest") && text.includes("if: always()") && text.includes("if-no-files-found: error") && text.includes("path: ${{ runner.temp }}/project-finish-context-diagnostic-selftest/summary.json") && text.includes("contents: read") && !text.includes("id-token:") && !text.includes("npm install") && !text.includes("npm ci")],

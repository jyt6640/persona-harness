...
Current active candidate: v0.3.0 workflow next-surface decision after the clean Gradle/Spring build-line smoke passed. v0.2.1 local/tarball validation is complete enough for continued local use; public publish remains deferred.
...
8. `[x]` v0.3.0 project-intake / philosophy workflow minimum surface
   ...
   - Next candidate: v0.3.0 workflow next-surface decision, likely interactive intake refinement or plan-review ergonomics before any autonomous agent track.

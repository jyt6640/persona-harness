...
Current active candidate: clean workflow smoke that verifies explicit plan acceptance before implementation. v0.2.1 local/tarball validation is complete enough for continued local use; public publish remains deferred.

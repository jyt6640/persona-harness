...
11. `[~]` v0.3.1 workflow diagnostics and external tester surface
   ...
   - Next candidate: run one clean short-TUI smoke against the new workflow-noise classification. Do not add backend shape rules or generated app quality gates from this result.

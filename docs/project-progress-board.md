...
Current active candidate: step fixture API contract scoping decision after generated Java target-role follow-up. v0.2.1 local/tarball validation is complete enough for continued local use; public publish remains deferred.

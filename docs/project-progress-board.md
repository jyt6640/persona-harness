...
Current active candidate: clean Java/Spring workflow smoke after step fixture API contract scoping. v0.2.1 local/tarball validation is complete enough for continued local use; public publish remains deferred.

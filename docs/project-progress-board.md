...
11. `[~]` v0.3.1 workflow diagnostics and external tester surface
   - Evidence: `docs/current/v0.3.1-workflow-diagnostics-surface.md`, `docs/evidence-reviews/v0.3.1-short-tui-workflow-smoke.md`, `docs/evidence-reviews/v0.3.1-review-report-short-tui-smoke.md`, `docs/evidence-reviews/v0.3.1-workflow-guard-clean-tui-smoke.md`, `docs/evidence-reviews/v0.3.1-workflow-runner-clean-tui-smoke.md`
   ...
   - Next candidate: narrow workflow-noise classification for raw environment probes and direct `.persona/rules` reads. Do not add backend shape rules or generated app quality gates from this result.

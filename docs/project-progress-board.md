...
Current active candidate: philosophy/policy overlay design after clean Java/Spring workflow smoke confirmed step contract scoping. v0.2.1 local/tarball validation is complete enough for continued local use; public publish remains deferred.

...
| `0.8.0-beta.18` | 2026-08-02 | Consumer Authority Beta source preparation | [`release notes`](../current/release/v0.8.0-beta.18-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | strict Node20 canonical tar to isolated Node24 publisher handoff; requires one hosted registry PUT and raw-byte/integrity/content-identity readback before any further lifecycle evidence |

...
| `0.8.0-beta.6` | 2026-07-27 | immutable Consumer Authority Beta staging evidence | [`release notes`](../current/release/v0.8.0-beta.6-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | prior registry/package evidence cannot satisfy beta.8 current-version cooperative, original-artifact, consumption, replay, or independent verification requirements |
...
| `0.8.0-beta.8` | 2026-07-29 | Consumer Authority Beta source preparation | [`release notes`](../current/release/v0.8.0-beta.8-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | strict staging-only prerelease source candidate; requires preserved source/packed native boundary, tag-bound publish/readback, one natural current-version artifact, pre-armed independent online verification inside the leaf certificate window, explicit consumption, and replay rejection |

...
| `0.8.0-beta.1` | 2026-07-24 | Consumer Authority Beta source preparation; no published lifecycle fact | [`release notes`](../current/release/v0.8.0-beta.1-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | registry not checked in this source candidate; a future staging-only lifecycle needs tag-bound publish/readback, exact-artifact provenance, and independent consumer verification |

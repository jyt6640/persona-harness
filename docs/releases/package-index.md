...
| `0.8.0-beta.23` | 2026-08-03 | historical Consumer Authority Beta v3 procedure evidence | [`release notes`](../current/release/v0.8.0-beta.23-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | all fifteen host-state roots were isolated, but its raw-empty Git cleanliness condition contradicted required runtime/build preparation and is superseded |
| `0.8.0-beta.24` | 2026-08-03 | Consumer Authority Beta V4 procedure-only source preparation | [`release notes`](../current/release/v0.8.0-beta.24-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | stage-scoped NUL-safe runtime residue projection, lstat/realpath containment, and immutable same-consumer source binding before one hosted residual |

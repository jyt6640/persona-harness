...
| `0.8.0-beta.12` | 2026-07-30 | Consumer Authority Beta source preparation | [`release notes`](../current/release/v0.8.0-beta.12-release-notes.md), [`beta lifecycle`](../current/release/consumer-authority-beta.md) | strict staging-only prerelease source candidate; its package-visible observer credential-preflight must pass before a natural current-version artifact can be authorized for online verification, installed fetch, explicit consumption, and replay rejection |

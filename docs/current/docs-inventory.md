...
| `docs/current/release/v0.8.0-beta.3-release-notes.md` | version-specific release note | v0.8.0-beta.3 | Historical immutable staging-only Consumer Authority Beta evidence; it is not beta.4 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.4-release-notes.md` | version-specific release note | v0.8.0-beta.4 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| `docs/current/release/consumer-authority-beta4-acceptance.json` | machine-readable release contract | v0.8.0-beta.4 | Fixed source/packed public lifecycle commands, bounded source-read evidence, adversarial classes, online verification availability boundary, and the single hosted current-version artifact residual. |

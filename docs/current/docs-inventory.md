...
- current active pointer/status: 33
...
| `docs/current/p2-u4-a-korean-output-coverage-audit.md` | current active pointer/status | - | U4-A read-only English/Korean output-family coverage audit; no localization implementation. |

...
| `docs/current/release/staged-package-verification.md` | operational stable | - | Read-only staged-package verification contract: exact-version preflight, registry/tarball facts, local install check, and separate promotion approval boundary. |

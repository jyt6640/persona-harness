...
| `docs/current/release/v0.8.0-beta.22-release-notes.md` | version-specific release note | v0.8.0-beta.22 | Current procedure-only Consumer Authority Beta source candidate: source-bound bootstrap precedes one final fixture commit, whose identical unpushed SHA remains the installed consumer CWD/HEAD. |
...
| `docs/current/release/consumer-authority-beta22-acceptance.json` | machine-readable release contract | v0.8.0-beta.22 | Current procedure-only source/packed observer contract binding the immutable final-observer procedure record, source-bound pre-push commit, and one hosted residual. |

...
| `docs/current/release/consumer-authority-beta13-acceptance.json` | machine-readable release contract | v0.8.0-beta.13 | Source/packed public Java/Spring pre-authority readiness contract, beta.12 historical outcome, fixed observer credential isolation, and one future current-version artifact residual. |

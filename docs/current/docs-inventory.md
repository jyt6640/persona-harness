...
| `docs/current/release/v0.8.0-beta.3-release-notes.md` | version-specific release note | v0.8.0-beta.3 | Historical immutable staging-only Consumer Authority Beta evidence; it is not beta.7 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.5-release-notes.md` | version-specific release note | v0.8.0-beta.5 | Historical Consumer Authority Beta source-preparation record; it makes no beta.7 current-version consumer authority, promotion, Stable/GA, or Finish authority claim. |
| `docs/current/release/v0.8.0-beta.6-release-notes.md` | version-specific release note | v0.8.0-beta.6 | Historical staging-only Consumer Authority Beta evidence; it is not beta.7 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.7-release-notes.md` | version-specific release note | v0.8.0-beta.7 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with outer-runner/nested-caller native capability; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| `docs/current/release/consumer-authority-beta7-acceptance.json` | machine-readable release contract | v0.8.0-beta.7 | Fixed source/packed public lifecycle commands, outer-runner/nested-caller capability manifest, native source-read adversarial classes, online verification availability boundary, and the single hosted current-version artifact residual. |

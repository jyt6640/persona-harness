...
| `docs/current/release/v0.8.0-beta.15-release-notes.md` | version-specific release note | v0.8.0-beta.15 | Current Consumer Authority Beta source-preparation record for an initialized public Finish state, same-consumer lifecycle, exact-once modeled consumption, and replay block; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta15-acceptance.json` | machine-readable release contract | v0.8.0-beta.15 | Source/packed public initialization, root-bound exact-tar package proof, and authority-backed Finish readiness contract with modeled exact-once consumption/replay and one future current-version artifact residual. |

...
| `docs/current/release/v0.8.0-beta.3-release-notes.md` | version-specific release note | v0.8.0-beta.3 | Historical immutable staging-only Consumer Authority Beta evidence; it is not beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.5-release-notes.md` | version-specific release note | v0.8.0-beta.5 | Historical Consumer Authority Beta source-preparation record; it makes no beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority claim. |
| `docs/current/release/v0.8.0-beta.6-release-notes.md` | version-specific release note | v0.8.0-beta.6 | Historical staging-only Consumer Authority Beta evidence; it is not beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.7-release-notes.md` | version-specific release note | v0.8.0-beta.7 | Historical immutable staging-only Consumer Authority Beta evidence. Its original artifact missed independent online verification inside its leaf certificate window and cannot satisfy beta.8 authority. |
| `docs/current/release/v0.8.0-beta.8-release-notes.md` | version-specific release note | v0.8.0-beta.8 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with the preserved native boundary and pre-armed live-verification deadline; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| `docs/current/release/consumer-authority-beta7-acceptance.json` | machine-readable release contract | v0.8.0-beta.7 | Historical source/packed lifecycle record retained with beta.7 staging evidence; it cannot satisfy beta.8 current-version authority. |
| `docs/current/release/consumer-authority-beta8-acceptance.json` | machine-readable release contract | v0.8.0-beta.8 | Fixed source/packed public lifecycle, beta.7 expiry fact, isolated observer pre-arm, online verification deadline, and one future current-version artifact residual. |

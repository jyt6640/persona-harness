...
| `docs/current/release/v0.8.0-beta.12-release-notes.md` | version-specific release note | v0.8.0-beta.12 | Historical Consumer Authority Beta staging evidence. Original artifact/crypto/fetch preparation passed, but public Finish retained readiness blockers and it supplies no beta.14 authority, consumption, or replay evidence. |
| `docs/current/release/v0.8.0-beta.13-release-notes.md` | version-specific release note | v0.8.0-beta.13 | Historical Consumer Authority Beta staging evidence. Current artifact crypto passed, but installed fetch retained no authority at the bootstrap-local source binding and supplies no beta.14 authority, consumption, or replay evidence. |
| `docs/current/release/v0.8.0-beta.14-release-notes.md` | version-specific release note | v0.8.0-beta.14 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with separate caller/reusable signer binding and a bootstrap-local source projection; it makes no live publish, tag, release, promotion, or Finish authority claim. |

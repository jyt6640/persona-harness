...
| `docs/current/release/v0.8.0-beta.3-release-notes.md` | version-specific release note | v0.8.0-beta.3 | Historical immutable staging-only Consumer Authority Beta evidence; it is not beta.11 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.5-release-notes.md` | version-specific release note | v0.8.0-beta.5 | Historical Consumer Authority Beta source-preparation record; it makes no beta.11 current-version consumer authority, promotion, Stable/GA, or Finish authority claim. |
| `docs/current/release/v0.8.0-beta.6-release-notes.md` | version-specific release note | v0.8.0-beta.6 | Historical staging-only Consumer Authority Beta evidence; it is not beta.11 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
...
| `docs/current/release/v0.8.0-beta.8-release-notes.md` | version-specific release note | v0.8.0-beta.8 | Historical Consumer Authority Beta staging evidence. Its original artifact verified live, but an obsolete caller workflow prearm retained no authority artifact and cannot satisfy beta.11 authority. |
...
| `docs/current/release/v0.8.0-beta.11-release-notes.md` | version-specific release note | v0.8.0-beta.11 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with a bounded ephemeral host-credential handoff; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta11-acceptance.json` | machine-readable release contract | v0.8.0-beta.11 | Source/packed current-version discovery-to-binding contract, beta.10 historical credentialless observation, caller/reusable identity separation, isolated observer `GH_TOKEN` pre-arm, and one future current-version artifact residual. |

...
| `docs/current/release/v0.8.0-beta.12-release-notes.md` | version-specific release note | v0.8.0-beta.12 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with a bounded host-only observer credential-preflight; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta12-acceptance.json` | machine-readable release contract | v0.8.0-beta.12 | Source/packed current-version discovery-to-binding contract, beta.11 historical preflight outcome, fixed observer credential isolation, and one future current-version artifact residual. |

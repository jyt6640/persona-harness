...
| `docs/current/release/consumer-authority-beta15-acceptance.json` | machine-readable release contract | v0.8.0-beta.15 | Source/packed public initialization and authority-backed Finish readiness contract with modeled exact-once consumption/replay and one future current-version artifact residual. |

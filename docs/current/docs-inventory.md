...
| `docs/current/release/v0.8.0-beta.3-release-notes.md` | version-specific release note | v0.8.0-beta.3 | Historical immutable staging-only Consumer Authority Beta evidence; it is not beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
| `docs/current/release/v0.8.0-beta.5-release-notes.md` | version-specific release note | v0.8.0-beta.5 | Historical Consumer Authority Beta source-preparation record; it makes no beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority claim. |
| `docs/current/release/v0.8.0-beta.6-release-notes.md` | version-specific release note | v0.8.0-beta.6 | Historical staging-only Consumer Authority Beta evidence; it is not beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority evidence. |
...
| `docs/current/release/v0.8.0-beta.8-release-notes.md` | version-specific release note | v0.8.0-beta.8 | Historical Consumer Authority Beta staging evidence. Its original artifact verified live, but an obsolete caller workflow prearm retained no authority artifact and cannot satisfy beta.10 authority. |
...
| `docs/current/release/v0.8.0-beta.10-release-notes.md` | version-specific release note | v0.8.0-beta.10 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with fixed caller-filename discovery and caller/reusable identity separation; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta10-acceptance.json` | machine-readable release contract | v0.8.0-beta.10 | Source/packed current-version discovery-to-binding contract, beta.9 historical endpoint failure, caller/reusable identity separation, isolated observer pre-arm, and one future current-version artifact residual. |

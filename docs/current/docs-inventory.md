...
| `docs/current/release/v0.8.0-beta.18-release-notes.md` | version-specific release note | v0.8.0-beta.18 | Current Consumer Authority Beta source-preparation record for the isolated Node20 canonical tar to Node24 trusted-publisher handoff; it makes no live publish, tag, release, promotion, or Finish authority claim. |

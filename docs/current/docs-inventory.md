...
| `docs/current/release/v0.8.0-beta.23-release-notes.md` | version-specific release note | v0.8.0-beta.23 | Historical procedure evidence: its raw-empty Git condition contradicted the required runtime/build preparation. |
| `docs/current/release/v0.8.0-beta.24-release-notes.md` | version-specific release note | v0.8.0-beta.24 | Current procedure-only Consumer Authority Beta candidate: V4 binds the immutable source map and stage-scoped NUL-safe runtime residue projections without allowing host state inside the consumer. |
...
| `docs/current/release/consumer-authority-beta23-acceptance.json` | machine-readable release contract | v0.8.0-beta.23 | Historical v3 source/packed observer contract retained for its immutable host-state isolation record; its raw-empty condition is superseded. |
| `docs/current/release/consumer-authority-beta24-acceptance.json` | machine-readable release contract | v0.8.0-beta.24 | Current V4 source/packed observer contract binding the reviewed stage-scoped residue record, same-consumer lifecycle, and one hosted residual. |

...
| `docs/current/release/v0.8.0-beta.12-release-notes.md` | version-specific release note | v0.8.0-beta.12 | Historical Consumer Authority Beta staging evidence. Original artifact/crypto/fetch preparation passed, but public Finish retained readiness blockers and it supplies no beta.13 authority, consumption, or replay evidence. |
| `docs/current/release/v0.8.0-beta.13-release-notes.md` | version-specific release note | v0.8.0-beta.13 | Current Consumer Authority Beta source-preparation record for a strict staging-only prerelease with observer credential readiness plus a public Java/Spring authority-only Finish blocker; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta12-acceptance.json` | machine-readable release contract | v0.8.0-beta.12 | Historical source/packed observer-preflight contract; its successful artifact/fetch preparation did not establish public Finish readiness or beta.13 authority evidence. |
| `docs/current/release/consumer-authority-beta13-acceptance.json` | machine-readable release contract | v0.8.0-beta.13 | Source/packed public Java/Spring pre-authority readiness contract with path-safe lifecycle output, beta.12 historical outcome, fixed observer credential isolation, and one future current-version artifact residual. |

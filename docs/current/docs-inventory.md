...
| `docs/current/release/v0.8.0-beta.19-release-notes.md` | version-specific release note | v0.8.0-beta.19 | Current Consumer Authority Beta source-preparation record for workflow-bound canonical source to registry-byte reconciliation; it makes no live publish, tag, release, promotion, or Finish authority claim. |
...
| `docs/current/release/consumer-authority-beta19-acceptance.json` | machine-readable release contract | v0.8.0-beta.19 | Source/packed lifecycle and package-root contract extended with workflow-bound canonical source-to-registry-byte reconciliation and sanitized failed-readback evidence. |

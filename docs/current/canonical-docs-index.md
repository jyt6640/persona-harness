...
| 0.8.0-beta.3 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.3-release-notes.md` | Historical immutable staging-only evidence; it does not establish beta.5 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
| 0.8.0-beta.5 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.5-release-notes.md` | Current staging-first source-preparation record for the complete public Java/Spring lifecycle, bounded source-read evidence, and current-version artifact boundary; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| 0.8.0-beta.5 acceptance record | `docs/current/release/consumer-authority-beta5-acceptance.json` | Machine-readable source/packed public lifecycle, adversarial proof map, fixed online custom-predicate route, and the single future hosted artifact residual. |

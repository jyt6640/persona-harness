...
| Consumer authority V1 decision | `docs/current/consumer-authority-v1-decision.md` | Future consumer-assurance contract: signed push evidence limits, separate user-scoped enrollment, public-only scope, cooperative same-invocation Gradle ownership, and non-consuming preview/consuming Finish semantics. No authority path is enabled. |

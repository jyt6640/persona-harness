...
| 0.7.0-rc.3 prepared release notes | `docs/current/release/v0.7.0-rc.3-release-notes.md` | Next-channel candidate record only; no tag, package, registry, Stable/GA, or `latest` fact yet. |

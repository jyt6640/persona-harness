...
| P2 baseline synchronization | `docs/current/p2-baseline-synchronization.md` | Current E/U/T/R investigation baseline, dependencies, acceptance gates, and no-automatic-activation boundary. |
| P2 U4-A Korean output coverage audit | `docs/current/p2-u4-a-korean-output-coverage-audit.md` | Read-only English/Korean output-family inventory, contract classification, and future localization unit boundaries. |
...
| 0.7.0-rc.2 published capsule | `docs/releases/v0.7.0-rc.2/README.md` | Current npm `next` candidate with registry gitHead/tag/workflow provenance. |
| 0.7.0-rc.1 published capsule | `docs/releases/v0.7.0-rc.1/README.md` | Previous published npm `next` candidate with registry gitHead/tag provenance. |

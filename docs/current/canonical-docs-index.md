...
| 0.7.0-rc.2 release-prep capsule | `docs/releases/v0.7.0-rc.2/README.md` | Current next-channel candidate facts and boundaries; pre-publish only. |
| 0.7.0-rc.1 published capsule | `docs/releases/v0.7.0-rc.1/README.md` | Published npm `next` candidate with registry gitHead/tag provenance. |

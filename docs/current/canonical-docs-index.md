...
| 0.7.0-rc.8 prepared release notes | `docs/current/release/v0.7.0-rc.8-release-notes.md` | Immutable source-preparation record for the staging-first candidate. It makes no live registry, tag, release, channel, provenance, or audit-completion claim. |

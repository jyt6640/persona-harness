...
| P3-8 CI/release integrity controls | `docs/current/p3-8-ci-release-integrity-acceptance-record.md` | PR/main CI and canonical-main/registry/release idempotency checks plus 2026-07-13 repository-admin readback; npm trusted-publisher verification and release approval remain separate gates. |

...
| 0.8.0-beta.22 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.22-release-notes.md` | Current procedure-only source candidate: source-bound bootstrap precedes one final fixture commit, and the same unpushed commit remains the installed consumer CWD/HEAD. |
| 0.8.0-beta.22 acceptance record | `docs/current/release/consumer-authority-beta22-acceptance.json` | Machine-readable beta22 procedure, package, observer, and one hosted residual contract; it changes no product authority behavior. |

...
| 0.8.0-beta.3 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.3-release-notes.md` | Historical immutable staging-only evidence; it does not establish beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
| 0.8.0-beta.5 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.5-release-notes.md` | Historical staging-only source-preparation record; it does not establish beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
| 0.8.0-beta.6 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.6-release-notes.md` | Historical staging-only evidence; it does not establish beta.8 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
...
| 0.8.0-beta.8 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.8-release-notes.md` | Current staging-first source-preparation record for the preserved native capability boundary and pre-armed one-shot live original-artifact observer; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| 0.8.0-beta.8 acceptance record | `docs/current/release/consumer-authority-beta8-acceptance.json` | Machine-readable source/packed lifecycle, beta.7 expiry outcome, fixed pre-arm order, live certificate deadline, and the single future hosted artifact residual. |

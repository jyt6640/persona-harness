...
| 0.8.0-beta.3 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.3-release-notes.md` | Current staging-first source-preparation record for the full public Java/Spring lifecycle and current-version artifact boundary; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| 0.8.0-beta.3 acceptance record | `docs/current/release/consumer-authority-beta3-acceptance.json` | Machine-readable source/packed public lifecycle, adversarial proof map, and the single future hosted artifact residual. |

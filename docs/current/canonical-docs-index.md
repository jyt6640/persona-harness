...
| 0.8.0-beta.3 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.3-release-notes.md` | Historical immutable staging-only evidence; it does not establish beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
| 0.8.0-beta.5 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.5-release-notes.md` | Historical staging-only source-preparation record; it does not establish beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
| 0.8.0-beta.6 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.6-release-notes.md` | Historical staging-only evidence; it does not establish beta.10 current-version consumer authority, promotion, Stable/GA, or Finish authority. |
...
| 0.8.0-beta.10 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.10-release-notes.md` | Current staging-first source-preparation record for fixed enrolled-filename discovery and caller/reusable identity separation; it makes no live publish, tag, release, promotion, or Finish authority claim. |
| 0.8.0-beta.10 acceptance record | `docs/current/release/consumer-authority-beta10-acceptance.json` | Machine-readable source/packed lifecycle, beta.9 historical discovery failure, fixed pre-arm order, and the single future hosted artifact residual. |

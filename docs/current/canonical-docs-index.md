...
| 0.8.0-beta.13 acceptance record | `docs/current/release/consumer-authority-beta13-acceptance.json` | Machine-readable source/packed pre-authority readiness, beta.12 historical outcome, credential isolation, and one future hosted artifact residual. |

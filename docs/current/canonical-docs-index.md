...
| 0.8.0-beta.23 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.23-release-notes.md` | Historical procedure evidence: its raw-empty Git condition contradicted the required runtime/build preparation. |
| 0.8.0-beta.23 acceptance record | `docs/current/release/consumer-authority-beta23-acceptance.json` | Historical v3 procedure, package, observer, and superseded hosted residual contract; it changes no product authority behavior. |
| 0.8.0-beta.24 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.24-release-notes.md` | Current procedure-only candidate: V4 replaces the contradictory raw-empty Git condition with stage-scoped NUL-safe runtime residue projections and containment checks. |
| 0.8.0-beta.24 acceptance record | `docs/current/release/consumer-authority-beta24-acceptance.json` | Machine-readable V4 procedure, package, observer, and one hosted residual contract; it changes no product authority behavior. |

...
| 0.8.0-beta.19 Consumer Authority Beta | `docs/current/release/v0.8.0-beta.19-release-notes.md` | Current source-preparation record for workflow-bound canonical source to registry-byte reconciliation and sanitized failed-readback evidence. |
| 0.8.0-beta.19 acceptance record | `docs/current/release/consumer-authority-beta19-acceptance.json` | Machine-readable source/packed lifecycle, package-root, canonical publisher, bounded observer plans, and one hosted registry reconciliation residual. |

...
| 0.7.0-rc.5 prepared release notes | `docs/current/release/v0.7.0-rc.5-release-notes.md` | Staging-first source candidate only; no tag, package, registry, promotion, Stable/GA, or `latest` fact. RC4 registry facts cannot bind to this fresh source identity. |

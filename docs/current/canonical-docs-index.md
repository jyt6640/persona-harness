...
| Staged package verification | `docs/current/release/staged-package-verification.md` | Read-only exact-version, registry-fact, local-tarball, and installed-package gate; it never authorizes channel promotion. |

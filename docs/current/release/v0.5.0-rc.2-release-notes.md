...
- `v0.5.0-rc.1`: remote tag already points at
  `dcc34e071d167923b8cf40be095b303ba649d3ca`;
- `v0.5.0-rc.2` tag: not created until registry gitHead/shasum verification
  passes after publish.

Because npm package versions are immutable, the corrected gate-first RC cannot
reuse `0.5.0-rc.1`. It advances to `0.5.0-rc.2`.

...
- The registry centralizes convention id, default level, blocker id, and fix
  path across observe, check, closure, continue, and write-warning surfaces.
- BYO `.persona/conventions/*.yml` ast-grep authoring remains future work.

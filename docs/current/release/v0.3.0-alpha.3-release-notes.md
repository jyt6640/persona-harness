...
- Pending: `latest` still resolves to `0.3.0-alpha.2` until the OTP-protected dist-tag sync is completed.
...
Finish OTP-protected `latest` dist-tag sync, then create the matching GitHub tag and release notes.

...
the convention registry. Current HEAD `b7b5c45` further routes closure blockers
through structured registry metadata; unsafe or low-precision rules must not
hard-block, and BYO `.persona/conventions/*.yml` ast-grep remains future work.

...
- Release operations and workflow-compatible release notes:
  ...
  [`release/v0.7.0-rc.6-release-notes.md`](release/v0.7.0-rc.6-release-notes.md).
...
- `0.7.0-rc.6` is source-prepared only as a staging-first prerelease
  ...
  gitHead must bind to its own exact protected-main source identity; RC5
  registry facts cannot authorize RC6. Published channels remain

...
- Release operations and workflow-compatible release notes:
  ...
  [`release/v0.8.0-beta.4-release-notes.md`](release/v0.8.0-beta.4-release-notes.md).
...
- `0.8.0-beta.1`, `0.8.0-beta.2`, and `0.8.0-beta.3` are immutable
  staging-only Consumer Authority Beta evidence. `0.8.0-beta.4` is the current

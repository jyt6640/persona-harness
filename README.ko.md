...
> 안정 npm 채널은 `persona-harness@latest=0.5.0`입니다. 게시된 prerelease 채널은 `next=0.6.0-rc.4`이고, alpha는 `0.3.9-alpha.8`입니다. 안정 `0.6.0`은 계속 보류 상태이며, `0.6.0-rc.4` registry smoke는 좁은 package-runtime evidence입니다.
